...
<body>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form class="d-flex align-items-center">
                        <a class="btn btn-info mr-2 ml-2" href="{{ route('anggota.create')}}"><i
                                class="bi bi-plus mr-2"></i>Tambah Anggota</a>
    ...
    <script>
        $(document).ready(function () {
            function fetchData() {
                $.ajax({
                    url: "{{ route('anggota.fetch') }}", // URL yang mengembalikan data terbaru
                    method: "GET",
                    success: function (data) {
                        $('#Anggota tbody').html(data);
                    }
                });
            }

            fetchData(); // Panggilan pertama saat halaman dimuat

            setInterval(fetchData, 5000); // Setiap 5 detik lakukan permintaan AJAX
        });
    </script>
